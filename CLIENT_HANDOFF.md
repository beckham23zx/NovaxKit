...
TapLog 的 Go 层和 Swift 层都已改为引用共享库。以下是完整的改动清单。
...
| 仓库 | 作用 | 详细文档 |
|------|------|---------|
| [NovaxKit](https://github.com/beckham23zx/NovaxKit) | Swift 共享包 | `GUIDE.md` — 架构全景 |
| | | `SHARED_CHANGELOG.md` — 变更日志 |
| [novax-common](https://github.com/beckham23zx/novax-common) | Go 共享模块 | `README.md` |
